...
export async function handler(event) {
  try {
    ...
    const apiUrl = `curl "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent" \
  -H 'Content-Type: application/json' \
  -H 'X-goog-api-key: AIzaSyA_W9YwpLlJ4QqNBmwVf4cTJOEx30uIW_I' \
  -X POST \
  -d '{
    "contents": [
      {
